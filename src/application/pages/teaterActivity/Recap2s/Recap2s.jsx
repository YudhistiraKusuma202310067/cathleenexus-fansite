...
const Recap2s = () => {
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        const q = query(collection(db, "2sEvents"), orderBy("date", "desc"));
        ...
        console.error("❌ Error fetching 2s events:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <UIScreenContainer>
      <div className="recapoffair-container">
        <h1 className="recapoffair-title">2s Cathy JKT48</h1>
          ...
          <div className="next-event-highlight">
            ...
            <div className="next-event-card">
              <img
                src={
                  nextEvent.imageUrl ||
                  "/src/assets/TeaterActivity/cathy-2s.jpg"
                }
                alt={nextEvent.title}
